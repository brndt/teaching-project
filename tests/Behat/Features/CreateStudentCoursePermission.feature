Feature: Create student course permission
  ...
  Scenario: Creating unit when all inputs are valid
    ...
    When I send a POST request to "/api/v1/panel/course_permission" with body:
    """
    {
    ...
    """
    {
      "message": "Course permission has been successfully created"
    }
    """
