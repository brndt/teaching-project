Feature: Create video resource
  ...
  Scenario: Creating unit when all inputs are valid
    ...
    When I send a POST request to "/api/v1/panel/courses/ea4f0311-4ffc-4fd0-9b4a-f2743565d851/units/5fd6fb25-a2a9-4376-af45-3c48508acd16/video_resources" with body:
    """
    {
      "name": "super resource12345",
