Feature: Authorized search test resource by id
  ...
  Scenario: search test resource by id when all inputs are valid
    ...
    And there are video resource student answers with the following details:
      | id                                   | resourceId                           | studentId                            | points | teacherComment | created                   | modified                  | status    | studentAnswer |
      | 4b71acce-eeda-475c-a4a2-6ac2fe472a7e | 6caf1483-92b9-4c67-b1fc-d0945052d1c3 | ab0642f0-ac7f-406a-903e-1c5480e7b7f8 | 10/10  | some comment   | 2020-07-14T13:54:13+00:00 | 2020-07-14T13:54:13+00:00 | published | test test     |
    ...
    When I send a GET request to "/api/v1/panel/video_resource_student_permission?resourceId=6caf1483-92b9-4c67-b1fc-d0945052d1c3&studentId=ab0642f0-ac7f-406a-903e-1c5480e7b7f8"
